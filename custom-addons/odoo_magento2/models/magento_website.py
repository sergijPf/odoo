...
class MagentoWebsite(models.Model):
    ...
    def show_instance(self):
        ...
        """
        view_ref = self.env['ir.model.data'].get_object_reference('odoo_magento2', 'view_magento_instance_form')
    ...
    def show_storeview(self):
        ...
        """
        view = self.env.ref('odoo_magento2.action_magento_storeview').sudo().read()[0]
